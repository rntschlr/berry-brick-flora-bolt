...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", { skip: !hasGrokScaffoldDocs }, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", { skip: !hasGrokScaffoldDocs }, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", { skip: !hasGrokScaffoldDocs }, () => {
